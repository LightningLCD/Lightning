/*
 * Qt5 bitoin/lightning GUI.
 * The Lightning Developer 2018
    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("Lightning") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/lightning"));
    setWindowIcon(QIcon(":icons/lightning"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/lightning1"), tr("&Dashboard"), this);
    overviewAction->setToolTip(tr("Show general overview of wallet"));
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/lightning1"), tr("&Receive"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(receiveCoinsAction);

    sendCoinsAction = new QAction(QIcon(":/icons/lightning1"), tr("&Send"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a Lightning address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(sendCoinsAction);

    historyAction = new QAction(QIcon(":/icons/lightning1"), tr("&Transactions"), this);
    historyAction->setToolTip(tr("Browse transaction history"));
    historyAction->setCheckable(true);
    historyAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_4));
    tabGroup->addAction(historyAction);

    addressBookAction = new QAction(QIcon(":/icons/lightning1"), tr("&Addresses"), this);
    addressBookAction->setToolTip(tr("Edit the list of stored addresses and labels"));
    addressBookAction->setCheckable(true);
    addressBookAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
    tabGroup->addAction(addressBookAction);

    masternodeManagerAction = new QAction(QIcon(":/icons/lightning1"), tr("&Masternodes"), this);
    masternodeManagerAction->setToolTip(tr("Show Master Nodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
    tabGroup->addAction(masternodeManagerAction);

    messageAction = new QAction(QIcon(":/icons/lightning1"), tr("&Messages"), this);
    messageAction->setToolTip(tr("View and Send Encrypted messages"));
    messageAction->setCheckable(true);
    tabGroup->addAction(messageAction);

    blockAction = new QAction(QIcon(":/icons/lightning1"), tr("&Block Explorer"), this);
...
//    Uncomment to build LC Adv
//
//    radioAction = new QAction(QIcon(":/icons/lightning1"), tr("&Radio"), this);
...
//    
//    bitcointalkAction = new QAction(QIcon(":/icons/lightning1"), tr("&Bitcointalk"), this);
...
//
//    twitterAction = new QAction(QIcon(":/icons/lightning1"), tr("&Twitter"), this);
...
//
//    bittrexAction = new QAction(QIcon(":/icons/lightning1"), tr("&Bittrex"), this);
...
//
//    coinexchangeAction = new QAction(QIcon(":/icons/lightning1"), tr("&Coinexchange"), this);
...
//
//    yobitAction = new QAction(QIcon(":/icons/lightning1"), tr("&Yobit"), this);
...
//    connect(yobitAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    ...
    aboutAction = new QAction(tr("&About Lightning"), this);
    aboutAction->setToolTip(tr("Show information about Lightning"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Lightning"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Lightning client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Lightning client"));
...
void BitcoinGUI::setNumI2PConnections(int count)
{
    ...
    labelI2PConnections->setToolTip(tr("%n active connection(s) to I2P-Lightning network", "", count));
}
#endif
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lightning network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Lightning address or malformed URI parameters."));
    }
