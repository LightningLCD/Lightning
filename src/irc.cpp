...
void ThreadIRCSeed()
{
    ...
    RenameThread("lightning-ircseed");
...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #lightningcoinTEST\r");
            Send(hSocket, "WHO #lightningcoinTEST\r");
        } else
        {
	    LogPrintf("JOIN #lightningcoin\n");
            // randomly join #lightningcoin00-#lightningcoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #lightningcoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #lightningcoin%02d\r", channel_number).c_str());
        };
