...
unsigned int nStakeMaxAge = 21 * 24 * 60 * 60; // 16 Days
...
const string strMessageMagic = "Lightning Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if (pindexBest->nHeight < 410)
    {
...
{
    RenameThread("lightning-loadblk");
